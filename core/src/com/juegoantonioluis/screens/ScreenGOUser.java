...
public class ScreenGOUser extends ScreenBase{
    // Creamos el objeto que actuara como imagen de fondo
    private Image background;
    // Creamos el objeto sera una imagen del coche
    private Image coche;
    // Creamos el objeto sera la imagen de Game Over
    ...
    public ScreenGOUser(Main main) {
        ...
        this.loose = main.assetsManager.getCancionLoose();
    }
    ...
    public void addBackground(){
        ...
        this.background =new Image(main.assetsManager.getGOBackground());
    ...
    //Metodo para añadir el coche roto
    public void addBrokenCar(){
        //Le pasamos a la variable coche, la imagen que cogemos desde AssetsManager
        this.coche =new Image(main.assetsManager.getGreenCar());
        // Declaramos la posicion donde queremos mostrarlo
        this.coche.setPosition(2f,0f);
        // ademas de declarar el tamaño
        this.coche.setSize(2.3f, 2f);
        // y se lo añadimos al stage como actor
        this.stage.addActor(this.coche);
    }
    ...
    public void addGameOver(){
        ...
        this.gameOver =new Image(main.assetsManager.getGameOver());
        // Declaramos la posicion donde queremos mostrarlo
        this.gameOver.setPosition(4f,2f);
        // ademas de declarar el tamaño
        this.gameOver.setSize(2f, 1.8f);
        // y se lo añadimos al stage como actor
