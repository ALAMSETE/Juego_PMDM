...
public class ScreenGetReady extends ScreenBase{
    // Creamos el objeto que actuara como imagen de fondo
    private Image background;
    // Creamos el objeto sera una imagen de la mano
    private Image tocar;
    ...
    public ScreenGetReady(Main main) {
        super(main);
    ...
    //Metodo para añadir la mano
    public void addTouch(){
        //Le pasamos a la variable tocar, la imagen que cogemos desde AssetsManager
        this.tocar =new Image(main.assetsManager.getTouch());
        // Declaramos la posicion donde queremos mostrarlo
        this.tocar.setPosition(4f,1f);
        // ademas de declarar el tamaño
        this.tocar.setSize(1.8f, 1.2f);
        // y se lo añadimos al stage como actor
        this.stage.addActor(this.tocar);
    }
    ...
    public void render(float delta) {
        ...
        // Si la pantalla es tocada, se ejecutara un nuevo juego
        if (Gdx.input.justTouched()){
            main.setScreen(new ScreenJuego(main));
        }
    }
